    ...
    <Container maxW="container.lg" my={10} lineHeight="taller">
      ...
      <Box mb={24}>
        ...
        <Text>
          ...
          fixent le cadre juridique de la Plateforme « Cause médicales de décès
          » et définissent les conditions d’accès et d’utilisation des services
          par l’Utilisateur.
        </Text>
        ...
        <Text>
          ...
          Régionales de Santé à accéder aux données relatives aux causes de
          décès, conformément aux articles L.1461-3 du code de la santé publique
          et L.2223-42 du code général des collectivités territoriales. Les
          personnes ont accès au service via un compte dédié.
        </Text>
        <Heading size="md" as="h3" mt={4} mb={2.5}>
          Article 2 – Objet
        </Heading>
        <Text>
          ...
          Agence régionales de santé, pour des motifs de santé publique,
          d’évaluer et orienter leurs actions en facilitant l’accès et
          l’interprétation des données de mortalité. Il participe également à
          l’aide à la décision et l’évaluation dans le domaine de la veille et
          la sécurité sanitaires, la définition, le financement et l’évaluation
          des actions de prévention et de promotion de la santé, l’anticipation,
        ...
        <Text>
          ...
          exerçant au sein de la DIRECTION DE L’INNOVATION, DE LA RECHERCHE ET
          DE LA TRANSFORMATION NUMERIQUE (DIRNOV).
        </Text>
        <Text mt={3}>
        ...
        <Text mt={3}>
          Données de cause médicale de décès : sont les informations comprises
          dans les certificats désignés par l’article L.2223-42 du code général
        ...
        <Heading size="xs" as="h3" mt={4} mb={2.5}>
          1 – Visualisation des informations figurant sur les certificats de
          causes de décès
        </Heading>
        <Text>
          Le service permet à l’Utilisateur de filtrer ses recherches en
          fonction de plusieurs critères pertinents pour les missions des agents
          de l’Agence régionale de Santé en entrant une « cause de décès » :
        </Text>
        <List ml={8} my={3}>
        ...
        <Text>
          L’Utilisateur peut également avoir accès aux autres informations
          contenues sur le certificat de causes de décès. Il peut également
          établir et recevoir des listes de recherches favorites.
        </Text>
        <Heading size="xs" as="h3" mt={4} mb={2.5}>
          2 – Export des informations
        </Heading>
        <Text>
          L’Utilisateur peut exporter les informations contenues dans le
          service, en cliquant sur le bouton « Export ». Il s’engage à ne pas
          exporter des informations dans un environnement non sécurisé ou
          permettant la réidentification des personnes par des personnes non
          habilitées.
        </Text>
        <Heading size="md" as="h3" mt={4} mb={2.5}>
        ...
        <Text>
          Chaque Utilisateur veille à la sécurité de ses identifiants
          (identifiant et mot de passe) et s’engage à utiliser un mot de passe
          robuste. Une fois connecté, l’Utilisateur s’engage à modifier son mot
          de passe de nature à le rendre sécurisé, conformément aux dispositions
          de la CNIL et de l’ANSSI.
        </Text>
        <Text mt={3}>
        ...
        <Text mt={3}>
          ...
          accès et s’engage à ne jamais diffuser de données non anonymes. Il
          n’est autorisé qu’à extraire des données du service, que pour des
          motifs de santé publique et notamment à des fins de veille et
          d’alerte.
        </Text>
        <Text mt={3}>
          L’Utilisateur est informé que ses actions sont tracées.
        </Text>
        <Text mt={3}>
          Le non-respect de ces dispositions entraine des sanctions civiles et
          pénales, notamment le fait de collecter des données à caractère
          personnel par un moyen frauduleux, déloyal ou illicite est puni de
          cinq d’emprisonnement et de 300 000 euros d’amende.
        </Text>
        <Heading size="md" as="h3" mt={4} mb={2.5}>
        ...
        <Text>
          ...
          motif jugé nécessaire. Chaque modification des CGU donne lieu à une
          nouvelle version qui doit être acceptée par les parties.
        </Text>
        <Text mt={3}>
          Vous pouvez avoir accès à un versionnage des CGU ici :
        </Text>
